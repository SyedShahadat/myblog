                ...
                <div id="sidebar-left" class="span2">
                    <div class="nav-collapse sidebar-nav">
                        <ul class="nav nav-tabs nav-stacked main-menu">
                            ...
                            <li><a href="{{URL::to('/manage-category')}}"><i class="icon-align-justify"></i><span class="hidden-tablet"> Manage Category</span></a></li>
                            <li><a href="{{URL::to('/add-blog')}}"><i class="icon-edit"></i><span class="hidden-tablet"> Add Blog</span></a></li>
                            <li><a href="{{URL::to('/manage-blog')}}"><i class="icon-align-justify"></i><span class="hidden-tablet"> Manage Blog</span></a></li>
